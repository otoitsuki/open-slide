...
export const zhTW: Locale = {
  ...
  stylePanel: {
    ...
    textLabel: '文字',
    accentLabel: '強調色',
    accentSecondaryLabel: '次要強調',
    surfaceLabel: '表面',
    surfaceAltLabel: '替代表面',
    mutedTextLabel: '次要文字',
    borderLabel: '邊框',
    codeTextLabel: '程式碼文字',
    commentTextLabel: '註解文字',
    displayFontLabel: '標題字型',
    bodyFontLabel: '內文字型',
    monoFontLabel: '等寬字型',
    heroLabel: '主標',
    headingLabel: '標題',
    ...
    codeSizeLabel: '程式碼',
    labelSizeLabel: '標籤',
    chartLabelSizeLabel: '圖表標籤',
    captionLabel: '說明',
    pageMarginLabel: '頁面邊距',
    sectionGapLabel: '區塊間距',
    itemGapLabel: '項目間距',
    cardShadowLabel: '卡片陰影',
    radiusLabel: '圓角',
    designToggle: '設計',
