...
export type Locale = {
  ...
  stylePanel: {
    ...
    textLabel: string;
    accentLabel: string;
    accentSecondaryLabel: string;
    surfaceLabel: string;
    surfaceAltLabel: string;
    mutedTextLabel: string;
    borderLabel: string;
    codeTextLabel: string;
    commentTextLabel: string;
    displayFontLabel: string;
    bodyFontLabel: string;
    monoFontLabel: string;
    heroLabel: string;
    headingLabel: string;
    bodyLabel: string;
    smallLabel: string;
    ...
    chartLabelSizeLabel: string;
    captionLabel: string;
    pageMarginLabel: string;
    sectionGapLabel: string;
    itemGapLabel: string;
