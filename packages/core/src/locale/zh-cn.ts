...
export const zhCN: Locale = {
  ...
  stylePanel: {
    ...
    textLabel: '文字',
    accentLabel: '强调色',
    accentSecondaryLabel: '次要强调',
    surfaceLabel: '表面',
    surfaceAltLabel: '替代表面',
    mutedTextLabel: '次要文字',
    borderLabel: '边框',
    codeTextLabel: '代码文字',
    commentTextLabel: '注释文字',
    displayFontLabel: '标题字体',
    bodyFontLabel: '正文字体',
    monoFontLabel: '等宽字体',
    heroLabel: '主标题',
    headingLabel: '标题',
    ...
    codeSizeLabel: '代码',
    labelSizeLabel: '标签',
    chartLabelSizeLabel: '图表标签',
    captionLabel: '说明',
    pageMarginLabel: '页面边距',
    sectionGapLabel: '区块间距',
    itemGapLabel: '项目间距',
    cardShadowLabel: '卡片阴影',
    radiusLabel: '圆角',
    designToggle: '设计',
