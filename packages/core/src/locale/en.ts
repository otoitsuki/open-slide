...
export const en: Locale = {
  ...
  stylePanel: {
    ...
    textLabel: 'Text',
    accentLabel: 'Accent',
    accentSecondaryLabel: 'Accent secondary',
    surfaceLabel: 'Surface',
    surfaceAltLabel: 'Surface alt',
    mutedTextLabel: 'Muted text',
    borderLabel: 'Border',
    codeTextLabel: 'Code text',
    commentTextLabel: 'Comment text',
    displayFontLabel: 'Display',
    bodyFontLabel: 'Body',
    monoFontLabel: 'Mono font',
    heroLabel: 'Hero',
    headingLabel: 'Heading',
    bodyLabel: 'Body',
    smallLabel: 'Small',
    codeSizeLabel: 'Code',
    labelSizeLabel: 'Label',
    chartLabelSizeLabel: 'Chart label',
    captionLabel: 'Caption',
    pageMarginLabel: 'Page margin',
    sectionGapLabel: 'Section gap',
    itemGapLabel: 'Item gap',
