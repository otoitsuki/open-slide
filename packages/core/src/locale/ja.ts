...
export const ja: Locale = {
  ...
  stylePanel: {
    ...
    colorsSection: 'カラー',
    typographySection: 'タイポグラフィ',
    spacingSection: 'スペーシング',
    shadowsSection: 'シャドウ',
    shapeSection: '形状',
    backgroundLabel: '背景',
    textLabel: 'テキスト',
    accentLabel: 'アクセント',
    accentSecondaryLabel: 'セカンダリ',
    surfaceLabel: 'サーフェス',
    surfaceAltLabel: 'サーフェス代替',
    mutedTextLabel: 'ミュート',
    borderLabel: 'ボーダー',
    codeTextLabel: 'コード',
    commentTextLabel: 'コメント',
    displayFontLabel: 'ディスプレイ',
    bodyFontLabel: '本文',
    monoFontLabel: '等幅',
    heroLabel: 'ヒーロー',
    headingLabel: '見出し',
    ...
    codeSizeLabel: 'コード',
    labelSizeLabel: 'ラベル',
    chartLabelSizeLabel: 'チャート',
    captionLabel: 'キャプション',
    pageMarginLabel: 'ページ余白',
    sectionGapLabel: 'セクション間隔',
    itemGapLabel: '項目間隔',
    cardShadowLabel: 'カードの影',
    radiusLabel: '角丸',
    designToggle: 'デザイン',
